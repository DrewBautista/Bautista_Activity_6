                    ...
                    public void onResponse(Call<List<CountryData>> call, Response<List<CountryData>> response) {
                        ...
                        for (int i = 0; i<list.size(); i++){
                            if (list.get(i).getCountry().equals("Philippines")){
                                ...
                                pieChart.addPieSlice(new PieModel("Confirm",confirm, Color.parseColor("#ecc246")));
                                pieChart.addPieSlice(new PieModel("Active",active, Color.parseColor("#53818d")));
                                pieChart.addPieSlice(new PieModel("Recovered",recovered, Color.parseColor("#509f83")));
